                        ...
                        <div class="card-body">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="ec-vendor-upload-detail">
                                    <form class="row g-3" method="POST" action="{{ route('seller.outSalesSave') }}"
                                        enctype="multipart/form-data">
                                        <!-- <form class="row g-3" > -->
                                        {!! csrf_field() !!}
                                        <input type="hidden" value="{{ $fetchsalesdata->id }}" name="sales_id">
                                        <div class="col-md-12">
                                            <div class="row">
                                                <input type="hidden" class="form-select1" readonly name="type"
                                                    value="OUT">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="div col-md-6 p-1 p-2">
                                                    <textarea class="form-select1 @error('productConfiguration') is-invalid @enderror" id="productConfiguration"
                                                        name="productConfiguration" rows="2">{{ $fetchsalesdata->productConfiguration }}</textarea>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="div col-md-6 p-1">
                                                    <input type="test"
                                                        ...
                                                        id="color" name="color" value="{{ $fetchsalesdata->color }}">
                                                    @error('color')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="div col-md-6 p-1">
                                                    <input type="test"
                                                        ...
                                                        value="{{ $fetchsalesdata->screenSize }}">
                                                    @error('screenSize')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                        ...
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="div col-md-6">
                                                    <label class="form-label">Purchase Date: <span>*</span></label>
                                                </div>
                                                <div class="div col-md-6 p-1">
                                                    <input type="date"
                                                        class="form-select1 @error('purchaseDate') is-invalid @enderror"
                                                        name="saleDate" id="dateID"
                                                        value="{{ $fetchsalesdata->saleDate }}">
                                                    @error('purchaseDate')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                                        ...
                                        <div class="col-md-12">
                                            <div class="row">
                                                <div class="div col-md-6">
                                                    <label class="form-label">Purchase Invoice: <span></span></label>
                                                </div>
                                                <div class="div col-md-6 p-1">
                                                    <input type="file"
