            ...
            var myLineChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        pointHitRadius: 20,
                        pointBorderWidth: 2,
                        data: response.complaint_registration_count_data // The response got from the ajax request containing data for the completed jobs in the corresponding months
                    }],
                },
                options: {
                    scales: {
