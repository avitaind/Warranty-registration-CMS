...
<body>
    ...
    <p>
        Hi, Product Warranty Registration: Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam officia voluptate
    ...
    <p><strong>S.No :</strong> {{ $WarrantyRegistration->serial_number }}</p>
    <p><strong>P.No :</strong> {{ $WarrantyRegistration->product_number }}</p>
    <p><strong>Purchase Date :</strong> {{ $WarrantyRegistration->purchase_date }}</p>
    <p><strong>Warranty Expiry :</strong> {{  date("Y-m-d", strtotime(date("Y-m-d", strtotime($WarrantyRegistration->purchase_date)) . " + 364 day"));}}</p>
</body>
