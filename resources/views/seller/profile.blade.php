        ...
        <div class="row">
            <div class="col-md-4 border-right">
                <div class="d-flex flex-column align-items-center text-center p-3 py-5">
                    <form method="POST" action="{{ route('sellerProfilesave') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                            ...
                            <div class="avatar-upload">
                                <div class="avatar-preview ec-preview">
                                    <div class="imagePreview ec-div-preview">
                                        @if ($user->pic != '')
                                            <img class="ec-image-preview" src="{{ '/' . $user->pic }}"
                                                alt="{{ $user->pic }}" style="width: 50%; padding-bottom: 20px;">
                                            <br />
                                        @else
                ...
                <div class="p-3 py-5">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-md-6"><label class="labels">First Name</label>
                            <input type="text" class="form-select1 " readonly placeholder="First name"
                                value="{{ Auth::user()->name }}" name="name">
                        </div>
                        <div class="col-md-6">
                            <label class="labels">Last Name</label>
                            <input type="text" class="form-select1 @error('last_name') is-invalid @enderror"
                                value="{{ $user->last_name }}" readonly placeholder="Last Name" name="last_name">
                            @error('last_name')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            ...
                            <input type="text" class="form-select1 @error('phone') is-invalid @enderror"
                                placeholder="Enter phone number" value="{{ $user->phone }}" name="phone">
                            @error('phone')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" readonly class="form-select1" placeholder="Enter email"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-select1 @error('postcode') is-invalid @enderror"
                                placeholder="Postcode" value="{{ $user->postcode }}" name="postcode">
                            @error('postcode')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-select1 @error('state') is-invalid @enderror"
                                value="{{ $user->state }}" placeholder="State" name="state">
                            @error('state')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
